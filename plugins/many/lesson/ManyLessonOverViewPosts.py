...
from plugins.xpath.lesson.LessonOverViewPath import Lesson_Over_View_Path
from plugins.basic.basic import Basic

import time
import datetime

class Many_Lesson_Over_View_Posts:

    def __init__(self, driver):
        self.chrome = driver
        self.driver_func = Driver_Action( driver )
        self.admin_xpath_list_func = Admin_Menu_Path()
        self.lesson_overview_xpath_list_func = Lesson_Over_View_Path()
    ...
    def add_lesson_over_view_page(self):
        ...
        self.lesson_overview_xpath_list_func.create_many_lesson_overview()
        lesson_overview = self.lesson_overview_xpath_list_func.get_many_lesson_overview()
