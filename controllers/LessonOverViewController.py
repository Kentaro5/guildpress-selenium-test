...
from plugins.lessonoverviewpost.LessonOverViewPosts import Lesson_Over_View_Posts

class Lesson_Over_View_Controller:
	...
	def start( self ):
		...
		#レッスンの概要を詰める
		self.lesson_over_view_posts_func.add_lesson_over_view_page()
