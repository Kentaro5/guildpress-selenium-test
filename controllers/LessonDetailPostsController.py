...
from plugins.lessondetailpost.LessonDetailPosts import Lesson_Detail_Posts

class Lesson_Detail_Posts_Controller:
	...
	def __init__(self, driver, target_url):
		...
		self.lesson_detail_posts_func = Lesson_Detail_Posts( driver )
	...
	def start( self ):
		...
		#レッスンの概要を詰める
		self.lesson_detail_posts_func.add_lesson_detail_page()
