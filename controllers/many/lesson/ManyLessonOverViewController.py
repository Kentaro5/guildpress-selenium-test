...
from plugins.many.lesson.ManyLessonOverViewPosts import Many_Lesson_Over_View_Posts

class Many_Lesson_Over_View_Controller:
    ...
    def __init__(self, driver, target_url):
        ...
        self.many_lesson_over_view_posts_func = Many_Lesson_Over_View_Posts( driver )
    ...
    def start( self ):
        ...
        # #レッスンの概要を詰める
        self.many_lesson_over_view_posts_func.add_lesson_over_view_page()
    ...
    def go_to_add_new_lesson_overview_page( self ):
        admin_guild_press_lesson_over_view_page_path = self.admin_xpath_lists['admin_guild_press_lesson_over_view_page_path']
        admin_guild_press_lesson_over_view_list_page_path = self.admin_xpath_lists['admin_guild_press_lesson_over_view_list_page_path']

        self.driver_action_func.move_admin_page( admin_guild_press_lesson_over_view_page_path, admin_guild_press_lesson_over_view_list_page_path )
